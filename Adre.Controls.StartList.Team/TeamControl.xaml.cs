...
namespace Adre.Controls.StartList.Team
{
    ...
    /// </summary>
    public partial class TeamControl : UserControl, IStartListButtonHandler
    {
        ...
        public event OnExportStartlistHandler OnExportStartlist;
        //angns
        ...
        private void ButtonDetailReport(object sender, RoutedEventArgs e)
        {
            ...
            var reportWindow = new ReportWindow(ReportManager.GenerateStartDetailList(selectedMatchId));
        ...
        private void OnExportStartlistClicked(object sender, EventArgs e)
        {
          OnExportStartlist?.Invoke(_dataContext, 1);
        }
  }
}
